...
$sensorCards = [
    [
        ...
        'status' => 'Good',
        'tone' => 'good',
        'detail' => 'Ideal range 22-26 C',
        'trend' => 'Stable in the last 30 minutes',
    ...
    [
        ...
        'status' => 'Safe',
        'tone' => 'good',
        'detail' => 'Holding safely between 24-27 C',
        'trend' => 'Stable in the fish tank loop',
    ...
    [
        ...
        'status' => 'Warning',
        'tone' => 'warning',
        'detail' => 'Target range 60-70%',
        'trend' => 'Drifting slightly below target',
    ...
    [
        ...
        'status' => 'Good',
        'tone' => 'good',
        'detail' => 'Nutrient balance looks healthy',
        'trend' => 'Inside hydroponic comfort zone',
        'updated' => 'Updated just now',
        'accent' => '#8b5cf6',
    ...
    [
        ...
        'status' => 'Warning',
        'tone' => 'warning',
        'detail' => 'Above the 0.5 ppm warning mark',
        'trend' => 'Biofilter adjustment recommended',
        'updated' => 'Updated 1 min ago',
        'accent' => '#f97316',
    ...
    [
        ...
        'status' => 'Danger',
        'tone' => 'danger',
        'detail' => 'Below the 500 lux target',
        'trend' => 'Lighting boost recommended',
    ...
    <div class="card-soft page-summary">
        ...
        <div class="d-flex align-items-center justify-content-between gap-3">
            <div>
                ...
                <small class="text-secondary">7 of 8 sensors reporting normally</small>
            </div>
        ...
        <div class="col-sm-6 col-xl-4">
            <div class="card-soft sensor-card" style="--sensor-accent: <?php echo htmlspecialchars($card['accent']); ?>; --sensor-soft: <?php echo htmlspecialchars($card['soft']); ?>;">
                ...
                <div class="sensor-reading">
                    <span class="sensor-value"><?php echo htmlspecialchars($card['value']); ?></span>
                ...
                <div class="sensor-meta">
                    ...
                    <span><?php echo htmlspecialchars($card['updated']); ?></span>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
    ...
    <div class="col-lg-4">
        <div class="card-soft h-100">
            <div class="d-flex justify-content-between align-items-start gap-3 mb-4">
                ...
                <span class="status-badge">7 Online</span>
            </div>
