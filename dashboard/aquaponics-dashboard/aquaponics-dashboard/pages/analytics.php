...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-3 analytics-header">
    ...
    <div class="card-soft analytics-overview">
        ...
        <div class="d-flex justify-content-between align-items-center gap-3">
            <div>
                <div class="overview-value">91%</div>
                <small class="text-secondary">Performance remains above weekly average</small>
            </div>
        ...
        <div class="card-soft chart-card">
            ...
            <div class="chart-meta">
                <div class="meta-tile">
                    ...
                    <strong>25.2 C</strong>
                </div>
                <div class="meta-tile">
                    <span>Water Temp Avg</span>
                    <strong>26.0 C</strong>
                </div>
                <div class="meta-tile">
                    <span>Humidity Range</span>
                    <strong>58% to 66%</strong>
                </div>
                <div class="meta-tile">
                ...
                <div class="meta-tile">
                    ...
                    <strong>0.18 to 0.62 ppm</strong>
                </div>
            </div>
        </div>
    </div>
