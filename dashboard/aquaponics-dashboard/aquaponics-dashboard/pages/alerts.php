...
<div class="d-flex flex-wrap justify-content-between align-items-end gap-3 alerts-header">
    ...
    <div class="card-soft alerts-overview">
        ...
        <div class="d-flex justify-content-between align-items-center gap-3">
            <div>
                <div class="overview-value"><?php echo htmlspecialchars((string) $activeAlertCount); ?></div>
        ...
        <div class="card-soft status-panel h-100">
            ...
            <div class="status-stack">
                <div class="status-metric">
                    ...
                    <strong><?php echo htmlspecialchars((string) $totalAlertsToday); ?></strong>
                    <p>Combined active and resolved incidents logged during the current day.</p>
                </div>

                <div class="status-metric">
                    <span>Active Alerts</span>
                    <strong><?php echo htmlspecialchars((string) $activeAlertCount); ?></strong>
                    <p>Incidents still open and waiting for intervention or automatic recovery.</p>
                </div>

                <div class="status-metric">
                    <span>System Health</span>
                    <strong><?php echo htmlspecialchars($healthLevel); ?></strong>
            ...
            <div class="severity-list">
                <div class="severity-row">
                    ...
                    <span class="status-badge badge-critical"><?php echo htmlspecialchars((string) $severityCounts['Critical']); ?></span>
                </div>
                ...
                <div class="severity-row">
                    ...
                    <span class="status-badge badge-warning"><?php echo htmlspecialchars((string) $severityCounts['Warning']); ?></span>
                </div>
                ...
                <div class="severity-row">
                    ...
                    <span class="status-badge badge-low"><?php echo htmlspecialchars((string) $severityCounts['Low']); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card-soft history-panel">
            <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
                ...
                <span class="status-badge"><?php echo htmlspecialchars((string) $totalAlertsToday); ?> logged today</span>
            </div>
