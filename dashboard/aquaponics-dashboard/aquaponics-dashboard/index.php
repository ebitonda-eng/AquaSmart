    ...
    <div class="col-sm-6 col-xl-2">
        <div class="card-soft dashboard-top-card" style="--card-accent:#2563eb; --card-soft:rgba(37,99,235,0.14);">
            ...
            <div>
                ...
                <div class="metric-value">26&deg;C</div>
    ...
    <div class="col-sm-6 col-xl-2">
        <div class="card-soft dashboard-top-card" style="--card-accent:#f97316; --card-soft:rgba(249,115,22,0.15);">
            ...
            <div>
                ...
                <div class="metric-value">0.62 ppm</div>
    ...
    <div class="col-md-4">
        <div class="compact-stack">
            <div class="card-soft compact-card">
                <h6>System Status</h6>
                <span class="compact-value">Normal</span>
                <p>All sensors operating normally</p>
            </div>

            <div class="card-soft compact-card">
                <h6>Water Usage</h6>
                <span class="compact-value">6.8 L</span>
                <p>Current monitored usage for the active irrigation window.</p>
            </div>

            <div class="card-soft compact-card">
                <h6>Active Pumps</h6>
                <span class="compact-value">1 Running</span>
    ...
    <div class="col-md-4">
        <div class="card-soft dashboard-panel h-100">
            <div class="section-head">
                ...
                <span class="section-pill">2 Active</span>
            </div>
            ...
            <div class="alerts-stack">
                <div class="dashboard-alert">
                    ...
                    <div>
                        ...
                        <p>Temperature readings moved above the preferred operating range.</p>
                    </div>
                </div>
                ...
                <div class="dashboard-alert">
                    ...
                    <div>
                        ...
                        <p>Reservoir capacity is nearing the refill threshold for the next cycle.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="card-soft water-panel h-100">
            <div class="section-head">
                ...
                <span class="section-pill">60%</span>
            </div>
            <div class="progress">
                <div id="waterBar" class="progress-bar bg-success" style="width:60%"></div>
            </div>
            <div class="water-meta">
                <span>Current capacity</span>
                <strong>60% available</strong>
            </div>
        </div>
    </div>
        ...
        <div class="card-soft pump-panel h-100">
            <div class="section-head">
                <div>
                    ...
                    <h5>Pump Control</h5>
                    <p>Quick actions for refill and circulation tasks.</p>
                </div>
                <span class="section-pill">Manual</span>
            </div>

            <div class="pump-actions">
                <button class="btn btn-soft pump-btn refill">Refill</button>
                <button class="btn btn-soft pump-btn circulation">Circulation</button>
            </div>
